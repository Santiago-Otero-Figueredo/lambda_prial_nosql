...
class NavegadorPersonalizado:
    ...
    def __configurar_browser(self):
        ...
        chrome_options.add_argument('--window-size={}x{}'.format(1920, 1080))
        chrome_options.add_argument('--hide-scrollbars')

        self._browser = webdriver.Chrome(chrome_options=chrome_options)
        logger.info('Using Chromium version: {}'.format(self._browser.capabilities['browserVersion']))
        
    def _retornar_browser(self):
